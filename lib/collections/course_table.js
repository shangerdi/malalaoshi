...
CourseTable.days = [1,2,3,4,5,6,7];
CourseTable.dayNumWords = ['天','一','二','三','四','五','六','日'];
CourseTable.experienceDays = 2; // 上体验课的天数
CourseTable.convMinutes2Str = function(mins) {
...
CourseTable.attendanceStateDict = courseAttendanceStateDict;

/**
 * 地区时间段表
 */
CourseTable.defaultTimePhases = [
