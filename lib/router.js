...
Router.route('/account/agreement', {name: 'accountAgreement'});
...
Router.onBeforeAction(requireLogin, {except: ['home', 'about','jobs', 'rights','mylogin','register','accountRole','accountEntry', 'accountAgreement']});
Router.onBeforeAction(onLoggedIn, {only: ['home','mylogin','register','accountRole','accountEntry', 'accountAgreement']});
