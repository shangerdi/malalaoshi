...
Router.route('/order/course/schedule/:teacherId?', {name: 'orderCourseSchedule'});
Router.route('/order/course/confirm', {name: 'orderCourseConfirm'});
Router.route('/order/course/pay', {name: 'orderCoursePay'});
