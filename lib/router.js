...
Router.route('/index', {name: 'index', layoutTemplate: 'appLayout'});
Router.route('/introduce', {name: 'introduce', layoutTemplate: 'appLayout'});
...
Router.route('/coupon/:id/confirm', {name: 'couponConfirm', layoutTemplate: 'appLayout'});
Router.route('/coupons/:get?', {name: 'coupons', layoutTemplate: 'appLayout'});
...
Router.route('/proceeds', { name: 'proceedsIndex',
  waitOn:function() {
    return Meteor.subscribe('proceeds');
  }
});
Router.route('/proceeds/security', { name: 'proceedsSecurity',
  waitOn:function() {
    return Meteor.subscribe('proceeds');
  }
});
Router.route('/proceeds/password', { name: 'proceedsPassword',
  waitOn:function() {
    return Meteor.subscribe('proceeds');
  }
});
Router.route('/proceeds/resetpasswordstep1', { name: 'proceedsResetPasswordStep1',
  waitOn:function() {
    return Meteor.subscribe('proceeds');
  }
});
Router.route('/proceeds/resetpasswordstep2', { name: 'proceedsResetPasswordStep2',
  waitOn:function() {
    return Meteor.subscribe('proceeds');
  }
});
Router.route('/proceeds/mycards', { name: 'proceedsMyCards',
  waitOn:function() {
    return Meteor.subscribe('proceeds');
  }
});
Router.route('/proceeds/addcardstep1', { name: 'proceedsAddCardStep1'});
Router.route('/proceeds/addcardstep2', { name: 'proceedsAddCardStep2'});
Router.route('/proceeds/addcardstep3', { name: 'proceedsAddCardStep3'});
Router.route('/proceeds/details', { name: 'proceedsDetails',
  waitOn:function() {
    return Meteor.subscribe('proceeds');
  }
});
Router.route('/proceeds/withdraw', { name: 'proceedsWithdraw',
  waitOn:function() {
    return Meteor.subscribe('proceeds');
  }
});
Router.route('/proceeds/selectcard', { name: 'proceedsSelectCard',
  waitOn:function() {
    return Meteor.subscribe('proceeds');
  }
});
...
Router.route('/teacher/:id', {name: 'teacher', layoutTemplate: 'directLayout'});
